...
public class EventRegistry {
	...
	public static void syncConfig(Configuration config) {
		...
		EventExtendedInventory.dropOnDeath = config.getBoolean("dropItemsOnDeath", category, true, "When false, this never drops your extra inventories items on death.  If true, this will obey the keepInventory rule");
