...
public class VillageStructureDruid extends StructureVillagePieces.House1 {
  ...
  public VillageStructureDruid(StructureBoundingBox boundingBox, EnumFacing par5) {
   ...
   * @return
   */
  public static VillageStructureDruid buildComponent(List<StructureComponent> pieces, int p1, int p2, int p3, EnumFacing p4) {
    StructureBoundingBox boundingBox = StructureBoundingBox.getComponentToAddBoundingBox(p1, p2, p3, 0, 0, 0, XSIZE, YSIZE, ZSIZE, p4);
    return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(pieces, boundingBox) == null ? new VillageStructureDruid(boundingBox, p4) : null;
  }

  @Override
  public boolean addComponentParts(World world, Random rand, StructureBoundingBox sbb) {
    int x = 6, y = 1, z = 6;
    this.spawnVillagers(world, sbb, x, y, z, VillagerCreateModule.druidCount);
    return true;
  }
