...
public class ItemEmeraldAxe extends ItemAxe implements IHasRecipe {
  ...
  public ItemEmeraldAxe() {
    ...
    super(EmeraldArmorModule.TOOL_MATERIAL_EMERALD, 6, -3);
  }
  @Override
  ...
  public void addRecipe() {
    GameRegistry.addShapedRecipe(new ItemStack(this), "ee ", "es ", " s ", 'e', new ItemStack(EmeraldArmorModule.REPAIR_EMERALD), 's', new ItemStack(Items.STICK));
    GameRegistry.addShapedRecipe(new ItemStack(this), " ee", " se", " s ", 'e', new ItemStack(EmeraldArmorModule.REPAIR_EMERALD), 's', new ItemStack(Items.STICK));
  }
}
