...
public class ItemLocation extends BaseItem implements IHasRecipe, IContent {
  ...
  public void syncConfig(Configuration config) {
    enabled = config.getBoolean(getName(), Const.ConfigCategory.items, true, Const.ConfigCategory.contentDefaultText + "  WARNING disabling this may cause other blocks to not function (wireless nodes)");
  }
