...
public class PacketStorageBagDeposit implements IMessage, IMessageHandler<PacketStorageBagDeposit, IMessage> {
  NBTTagCompound tags = new NBTTagCompound();
  public PacketStorageBagDeposit() {
  }
  public PacketStorageBagDeposit(NBTTagCompound ptags) {
    tags = ptags;
  }
  @Override
  ...
  @Override
  public IMessage onMessage(PacketStorageBagDeposit message, MessageContext ctx) {
