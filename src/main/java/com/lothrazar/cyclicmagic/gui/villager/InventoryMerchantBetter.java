...
//return  this.theMerchant.getRecipes(this.thePlayer);
  ...
  {  
System.out.println("resetRecipeAndSlots() index = "+this.currentRecipeIndex);
...
if(this.thePlayer.worldObj.isRemote){
  ModCyclic.logger.info(merchantrecipelist.size()+"resetRecipeAndSlots "+this.thePlayer.worldObj.isRemote);
