...
public class GuiSpellWheel extends GuiScreen {
	...
	public void initGui() {
		...
		// List<Integer> spellbook = ;//
		// ItemCyclicWand.Variant.getSpellsFromVariant(ItemCyclicWand.Variant.getVariantFromMeta(wand));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		/*
		 * List<Integer> spellbook =
		 * ItemCyclicWand.Variant.getSpellsFromVariant(ItemCyclicWand.Variant.
		 * getVariantFromMeta(thePlayer.getHeldItem()));
		 * 
		 * 
		 * double ang = 0;
		 * double cx, cy;
		 ...
		 * UtilTextureRender.drawTextureSimple(header, (int) cx, (int) cy - 8,
		 * spellSize - 4, spellSize - 4);
		 * 
		 * ang += arc;
		 * }
		 */
