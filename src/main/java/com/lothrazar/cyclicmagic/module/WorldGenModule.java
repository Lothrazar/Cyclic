...
public class WorldGenModule extends BaseEventModule implements IHasConfig {
  ...
  private void registerDimensionOres() {
    ...
    BlockRegistry.registerBlock(nether_redstone_ore, "nether_redstone_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(nether_iron_ore, "nether_iron_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(nether_gold_ore, "nether_gold_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(nether_coal_ore, "nether_coal_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(nether_lapis_ore, "nether_lapis_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(nether_emerald_ore, "nether_emerald_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(nether_diamond_ore, "nether_diamond_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(end_redstone_ore, "end_redstone_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(end_coal_ore, "end_coal_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(end_lapis_ore, "end_lapis_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(end_emerald_ore, "end_emerald_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(end_diamond_ore, "end_diamond_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(end_gold_ore, "end_gold_ore",CategoryType.WORLD);
    ...
    BlockRegistry.registerBlock(end_iron_ore, "end_iron_ore",CategoryType.WORLD);
