...
public class BlockPlateModule extends BaseModule implements IHasConfig {
  ...
  public void onPreInit() {
    ...
    if (launchPads) {
      ...
      BlockRegistry.registerBlock(plate_launch_small, "plate_launch_small",GuideCategory.BLOCKPLATE);
      ...
      BlockRegistry.registerBlock(plate_launch_large, "plate_launch_large",GuideCategory.BLOCKPLATE);
    ...
    if (enableConveyor) {
     ...
     RecipeRegistry.addShapedRecipe(new ItemStack(plate_push, 8),
      ...
      BlockRegistry.registerBlock(plate_push_fast, "plate_push_fast",GuideCategory.BLOCKPLATE);
      ...
      BlockRegistry.registerBlock(plate_push_slow, "plate_push_slow",GuideCategory.BLOCKPLATE);
      ...
      BlockRegistry.registerBlock(plate_push_slowest, "plate_push_slowest",GuideCategory.BLOCKPLATE);
