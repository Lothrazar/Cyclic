...
public class BlockPlateModule extends BaseModule implements IHasConfig {
  ...
  public void onPreInit() {
    ...
    if (enableInterdict) {
      ...
      BlockRegistry.registerBlock(magnet_anti_block, "magnet_anti_block",GuideCategory.BLOCK);
      GameRegistry.registerTileEntity(TileEntityMagnetAnti.class, "magnet_anti_block_te");
    }
    if (enableMagnet) {
      BlockMagnet magnet_block = new BlockMagnet();
      BlockRegistry.registerBlock(magnet_block, "magnet_block",GuideCategory.BLOCK);
    ...
    if (launchPads) {
      ...
      BlockRegistry.registerBlock(plate_launch_small, "plate_launch_small",GuideCategory.BLOCK);
      plate_launch_med = new BlockLaunch(1.3F, SoundEvents.BLOCK_SLIME_FALL);
      BlockRegistry.registerBlock(plate_launch_med, "plate_launch_med",GuideCategory.BLOCK);
      BlockLaunch plate_launch_large = new BlockLaunch(1.8F, SoundEvents.BLOCK_SLIME_BREAK);
      BlockRegistry.registerBlock(plate_launch_large, "plate_launch_large",GuideCategory.BLOCK);
    ...
    if (enableConveyor) {
      ...
      BlockRegistry.registerBlock(plate_push, "plate_push",GuideCategory.BLOCK);
     ...
     RecipeRegistry.addShapedRecipe(new ItemStack(plate_push, 8),
      ...
      BlockRegistry.registerBlock(plate_push_fast, "plate_push_fast",GuideCategory.BLOCK);
      ...
      BlockRegistry.registerBlock(plate_push_slow, "plate_push_slow",GuideCategory.BLOCK);
      ...
      BlockRegistry.registerBlock(plate_push_slowest, "plate_push_slowest",GuideCategory.BLOCK);
    ...
    if (vectorPlate) {
      ...
      BlockRegistry.registerBlock(plate_vector, new ItemBlockVectorPlate(plate_vector), "plate_vector",GuideCategory.BLOCK);
