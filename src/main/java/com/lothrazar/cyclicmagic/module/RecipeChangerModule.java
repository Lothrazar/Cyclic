...
public class RecipeChangerModule extends BaseModule implements IHasConfig {
  ...
  private void furnaceNeedsCoal() {
    ...
    RecipeRegistry.addShapedRecipe(new ItemStack(Blocks.FURNACE), "bbb", "bcb", "bbb", 'b', Blocks.COBBLESTONE, 'c', Items.COAL);
  }
  private void smoothstoneRequired() {
    ...
    RecipeRegistry.addShapedRecipe(new ItemStack(Items.STONE_PICKAXE),
        "sss", " t ", " t ",
    ...
    RecipeRegistry.addShapedRecipe(new ItemStack(Items.STONE_SWORD), " s ", " s ", " t ",
        's', new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.STONE.ordinal()),
        't', Items.STICK);
    ...
    RecipeRegistry.addShapedRecipe(new ItemStack(Items.STONE_AXE), "ss ", "st ", " t ",
        's', new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.STONE.ordinal()),
        't', Items.STICK);
    RecipeRegistry.addShapedRecipe(new ItemStack(Items.STONE_AXE), " ss", " ts", " t ",
        's', new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.STONE.ordinal()),
        't', Items.STICK);
    ...
    //    GameRegistry.addRecipe(new ItemStack(Items.STONE_HOE, 1, UtilItem.getMaxDmgFraction(Items.STONE_HOE, 4)), " ss", " t ", " t ", 's', Blocks.COBBLESTONE, 't', Items.STICK);
    RecipeRegistry.addShapedRecipe(new ItemStack(Items.STONE_HOE), "ss ", " t ", " t ",
        's', new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.STONE.ordinal()),
        't', Items.STICK);
    RecipeRegistry.addShapedRecipe(new ItemStack(Items.STONE_HOE), " ss", " t ", " t ",
        's', new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.STONE.ordinal()),
    ...
    RecipeRegistry.addShapedRecipe(new ItemStack(Items.STONE_SHOVEL), " s ", " t ", " t ",
        's', new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.STONE.ordinal()),
        't', Items.STICK);
