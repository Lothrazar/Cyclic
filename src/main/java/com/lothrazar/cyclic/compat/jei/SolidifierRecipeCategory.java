...
public class SolidifierRecipeCategory implements IRecipeCategory<RecipeHolder<RecipeSolidifier>> {
  ...
  @Override
  public void draw(RecipeHolder<RecipeSolidifier> recipeHolder, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor ms, double mouseX, double mouseY) {
    gui.draw(ms, 0, 0);
    var recipe = recipeHolder.value();
    ms.text(font, recipe.getEnergy().getRfPertick() + " RF/t", 55, 10, FONT);
