...
public class DataTags {
  ...
  public static final INamedTag<Item> ANVIL_IMMUNE = ItemTags.makeWrapperTag(ModCyclic.MODID + ":anvil_immune");
  public static final INamedTag<Item> DISENCHANTER_IMMUNE = ItemTags.makeWrapperTag(ModCyclic.MODID + ":disenchanter_immune");
}
