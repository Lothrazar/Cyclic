...
//  @OnlyIn(Dist.CLIENT)
  public void appendHoverText(ItemStack stack, Item.TooltipContext  worldIn, List<Component> tooltip, TooltipFlag flagIn) {
    ...
    CompoundTag stackdata = stack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag();
  ...
  public InteractionResult useOn(UseOnContext context) {
    ...
    if (player.level().getBlockState(pos).getBlock() == Blocks.BEDROCK) {
      //      Blocks.BEDROCK.isu
      held.remove(net.minecraft.core.component.DataComponents.CUSTOM_DATA); //clear
      ChatUtil.addChatMessage(player, getDescriptionId() + ".deleted");
    }
    //
    CompoundTag stackdata = held.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag();
    if (stackdata == null || stackdata.isEmpty()) {
      ...
      if (tile instanceof TileBlockEntityCyclic) {
        ...
        held.set(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.of(tiledata));
