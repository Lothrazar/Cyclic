...
public class EdibleFlightItem extends AppleBuffs {
  ...
  public ItemStack finishUsingItem(ItemStack stack, Level worldIn, LivingEntity entity) {
    ...
    if (entity.hasEffect(flight)) {
      ...
      currentEff.update(new net.minecraft.world.effect.MobEffectInstance(com.lothrazar.cyclic.registry.PotionEffectRegistry.FLIGHT, currentEff.getDuration() + TICKS.get())); // update to merge together new and existing timers
    }
    else {
