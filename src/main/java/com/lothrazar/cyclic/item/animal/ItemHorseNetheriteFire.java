...
public class ItemHorseNetheriteFire extends ItemBaseCyclic implements IEntityInteractable {

  public static final String NBT_KEY = ModCyclic.MODID + "_carrot_netherite";

  public ItemHorseNetheriteFire(Properties prop) {
    super(prop);
  }
