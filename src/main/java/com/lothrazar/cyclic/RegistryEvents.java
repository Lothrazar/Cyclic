...
public class RegistryEvents {
  ...
  public static void onItemsRegistry(RegistryEvent.Register<Item> event) {
    ...
    r.register(new SwordItem(ItemTier.DIAMOND, 3, -2.4F, (new Item.Properties()).group(CyclicRegistry.itemGroup)).setRegistryName("crystal_sword"));
    r.register(new PickaxeItem(ItemTier.DIAMOND, 1, -2.8F, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_pickaxe"));
    r.register(new AxeItem(ItemTier.DIAMOND, 5.0F, -3.0F, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_axe"));
    r.register(new HoeItem(ItemTier.DIAMOND, 0.0F, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_hoe"));
    r.register(new ShovelItem(ItemTier.DIAMOND, 1.5F, -3.0F, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_shovel"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.FEET, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_boots"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.HEAD, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_helmet"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.CHEST, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_chestplate"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.LEGS, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_leggings"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.FEET, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_boots"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.HEAD, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_helmet"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.CHEST, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_chestplate"));
    r.register(new ArmorItem(ArmorMaterial.DIAMOND, EquipmentSlotType.LEGS, new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_leggings"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_sword"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_pickaxe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_axe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_hoe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("sandstone_sword"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("sandstone_pickaxe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("sandstone_axe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("sandstone_hoe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("sandstone_shovel"));
    //    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("netherbrick_sword"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("netherbrick_pickaxe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("netherbrick_axe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("netherbrick_hoe"));
    //    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("netherbrick_shovel"));
