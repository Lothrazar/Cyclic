...
public class RegistryEvents {
  ...
  public static void onItemsRegistry(RegistryEvent.Register<Item> event) {
    ...
    r.register(new ItemHorseLapisVariant(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("toxic_carrot"));
    ...
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_sword"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_pickaxe"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_axe"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_hoe"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_shovel"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_boots"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_helmet"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_chestplate"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("crystal_leggings"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_boots"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_helmet"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_chestplate"));
    r.register(new Item(new Item.Properties().group(CyclicRegistry.itemGroup)).setRegistryName("emerald_leggings"));
