...
public class RenderDetectorItem implements BlockEntityRenderer<TileDetectorItem, RenderDetectorItem.State> {

  public static class State extends BlockEntityRenderState {
    TileDetectorItem blockEntity;
  }

  public RenderDetectorItem(BlockEntityRendererProvider.Context d) {}

  @Override
  public boolean shouldRender(TileDetectorItem blockEntity, Vec3 cameraPosition) {
    return true;
  }
  ...
  @Override
  public void extractRenderState(TileDetectorItem blockEntity, State state, float partialTicks, Vec3 cameraPosition,
  ...
  public void submit(State state, PoseStack matrixStack, SubmitNodeCollector submitNodeCollector, CameraRenderState camera) {
    TileDetectorItem te = state.blockEntity;
