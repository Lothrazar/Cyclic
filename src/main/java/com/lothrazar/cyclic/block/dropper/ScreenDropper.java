...
public class ScreenDropper extends ScreenBase<ContainerDropper> {
  ...
  public void init() {
    ...
    dropcount.setTooltip(net.minecraft.client.gui.components.Tooltip.create(net.minecraft.network.chat.Component.translatable("cyclic.dropper.count")));
    y += h + 1;
    ...
    delaysli.setTooltip(net.minecraft.client.gui.components.Tooltip.create(net.minecraft.network.chat.Component.translatable("cyclic.dropper.delay")));
  }
