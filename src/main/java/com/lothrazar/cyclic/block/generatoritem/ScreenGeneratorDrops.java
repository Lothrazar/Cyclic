...
public class ScreenGeneratorDrops extends ScreenBase<ContainerGeneratorDrops> {
  ...
  public void render(MatrixStack ms, int mouseX, int mouseY, float partialTicks) {
    ...
    progress.renderHoveredToolTip(ms, mouseX, mouseY, container.tile.getField(TileGeneratorDrops.Fields.TIMER.ordinal()));
  ...
  protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int mouseX, int mouseY) {
    ...
    progress.draw(ms, container.tile.getField(TileGeneratorDrops.Fields.TIMER.ordinal()));
  }
}
