...
public class ScreenPlanter extends ScreenBase<ContainerPlanter> {

  private ButtonMachine btnRedstone;
  private EnergyBar energy;

  public ScreenPlanter(ContainerPlanter screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    super(screenContainer, inv, titleIn);
    this.energy = new EnergyBar(this, TilePlanter.MAX);
  }
  ...
  public void init() {
    ...
    btnRedstone = addButton(new ButtonMachine(x, y, 20, 20, "", (p) -> {
      ...
      PacketRegistry.INSTANCE.sendToServer(new PacketTileData(TilePlanter.Fields.REDSTONE.ordinal(), container.tile.getNeedsRedstone(), container.tile.getPos()));
    }));
  }
