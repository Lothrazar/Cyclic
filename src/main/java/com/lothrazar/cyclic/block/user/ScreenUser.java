...
public class ScreenUser extends ScreenBase<ContainerUser> {
  ...
  public void init() {
    ...
    slider.setTooltip(net.minecraft.client.gui.components.Tooltip.create(net.minecraft.network.chat.Component.translatable("block.cyclic.user.delay")));
    h = 14;
  ...
  protected void renderLabels(GuiGraphics ms, int mouseX, int mouseY) {
    ...
    btnType.setTooltip(net.minecraft.client.gui.components.Tooltip.create(net.minecraft.network.chat.Component.literal("block.cyclic.user.type." + menu.tile.doHitBreak)));
    btnEntities.onValueUpdate(menu.tile);
    btnEntities.setTooltip(net.minecraft.client.gui.components.Tooltip.create(net.minecraft.network.chat.Component.literal("block.cyclic.user.entities." + menu.tile.entities)));
