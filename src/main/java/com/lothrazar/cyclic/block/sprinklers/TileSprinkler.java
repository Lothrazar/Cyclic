...
public class TileSprinkler extends TileEntityBase implements INamedContainerProvider, ITickableTileEntity {
  ...
  public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity) {
    return null;//    return new ContainerForester(i, world, pos, playerInventory, playerEntity);
  }
