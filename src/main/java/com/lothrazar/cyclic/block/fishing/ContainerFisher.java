...
public class ContainerFisher extends ContainerBase {
  ...
  public ContainerFisher(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
    super(ContainerScreenRegistry.fisher, windowId);
    tile = (TileFisher) world.getTileEntity(pos);
  ...
  public boolean canInteractWith(PlayerEntity playerIn) {
    return isWithinUsableDistance(IWorldPosCallable.of(tile.getWorld(), tile.getPos()), playerEntity, BlockRegistry.fisher);
  }
}
