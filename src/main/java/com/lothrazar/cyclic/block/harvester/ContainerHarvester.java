...
public class ContainerHarvester extends ContainerBase {
  ...
  public ContainerHarvester(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
    super(MenuTypeRegistry.HARVESTER.get(), windowId);
  ...
  public boolean stillValid(Player playerIn) {
    return stillValid(ContainerLevelAccess.create(tile.getLevel(), tile.getBlockPos()), playerEntity, BlockRegistry.HARVESTER.get());
  }
}
