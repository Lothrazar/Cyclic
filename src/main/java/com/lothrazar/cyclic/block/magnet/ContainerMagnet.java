...
public class ContainerMagnet extends ContainerBase {
  ...
  public ContainerMagnet(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
    ...
    this.trackAllIntFields(tile, TileMagnet.Fields.values().length);
    trackEnergy(tile);
  }
  ...
  public boolean canInteractWith(PlayerEntity playerIn) {
    return isWithinUsableDistance(IWorldPosCallable.of(tile.getWorld(), tile.getPos()), playerEntity, BlockRegistry.magnet);
  }
}