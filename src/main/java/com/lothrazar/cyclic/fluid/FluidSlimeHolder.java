...
public class FluidSlimeHolder {
  ...
  private static final ResourceLocation FLUID_STILL = ResourceLocation.fromNamespaceAndPath("minecraft", "block/slime_block");
  private static final ResourceLocation FLUID_FLOWING = ResourceLocation.fromNamespaceAndPath("minecraft", "block/slime_block");
  ...
  public static final DeferredHolder<Fluid, SlimeFluidBlock.Source> STILL = FluidRegistry.FLUID.register(ID, () -> new SlimeFluidBlock.Source(makeProperties()));
  public static final DeferredHolder<Fluid, SlimeFluidBlock.Flowing> FLOWING = FluidRegistry.FLUID.register(ID + "_flowing", () -> new SlimeFluidBlock.Flowing(makeProperties()));
