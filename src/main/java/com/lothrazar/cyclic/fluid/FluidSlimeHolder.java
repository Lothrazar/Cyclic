...
public class FluidSlimeHolder {
  ...
  public static final ResourceLocation FLUID_STILL = ResourceLocation.fromNamespaceAndPath("minecraft", "block/slime_block");
  public static final ResourceLocation FLUID_FLOWING = ResourceLocation.fromNamespaceAndPath("minecraft", "block/slime_block");
  ...
  public static final DeferredHolder<Fluid, ConfigurableFlowingFluid.Source> STILL = FluidRegistry.FLUID.register(ID, () -> new ConfigurableFlowingFluid.Source(makeProperties(), 1, 6));
  public static final DeferredHolder<Fluid, ConfigurableFlowingFluid.Flowing> FLOWING = FluidRegistry.FLUID.register(ID + "_flowing", () -> new ConfigurableFlowingFluid.Flowing(makeProperties(), 1, 2));

  public static final DeferredBlock<SlimeFluidBlock> BLOCK = BlockRegistry.BLOCKS.register(ID + "_block",
      () -> new SlimeFluidBlock(STILL, Block.Properties.of().liquid().noCollission().strength(100.0F).noLootTable()));
