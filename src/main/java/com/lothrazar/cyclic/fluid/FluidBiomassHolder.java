...
public class FluidBiomassHolder {
  ...
  public static final DeferredBlock<BiomassFluidBlock> BLOCK = BlockRegistry.BLOCKS.register(ID + "_block",
      () -> new BiomassFluidBlock(STILL, Block.Properties.of().liquid().noCollission().strength(100.0F).noLootTable()));
