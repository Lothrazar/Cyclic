...
public class FluidRedstoneHolder {
  ...
  public static final DeferredBlock<RedstoneFluidBlock> BLOCK = BlockRegistry.BLOCKS.registerBlock(ID + "_block",
      props -> new RedstoneFluidBlock(STILL, props.liquid().replaceable().noCollision().strength(100.0F).lightLevel(s -> LIGHT_LEVEL).noLootTable()));
