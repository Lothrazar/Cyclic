...
public class PotionEffectRegistry {
  ...
  public static final RegistryObject<MobEffect> ANTIGRAVITY = MOB_EFFECTS.register("antigravity", () -> new AttrEffect(MobEffectCategory.BENEFICIAL, 0x730043)
  ...
  //  public static final RegistryObject<MobEffect> angelic = MOB_EFFECTS.register("angelic", () -> new AngelEffect(MobEffectCategory.HARMFUL, 0x224BAF));
}