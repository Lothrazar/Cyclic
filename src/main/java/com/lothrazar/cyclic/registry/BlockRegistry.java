...
public class BlockRegistry {
  ...
  public static void onBlocksRegistry(final RegistryEvent.Register<Block> event) {
    ...
    r.register(new Block(Block.Properties.create(Material.ROCK)).setRegistryName("mason_cobble"));
    r.register(new Block(Block.Properties.create(Material.ROCK)).setRegistryName("mason_stone"));
