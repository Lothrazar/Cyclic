...
public class EnchantRegistry {
  ...
  public static final EnchantmentCyclic MULTIBOW = (EnchantmentCyclic) new MultishotEnchant(Enchantment.Rarity.UNCOMMON, EnchantmentCategory.BOW, EquipmentSlot.MAINHAND).setRegistryName(MultishotEnchant.ID);
