...
public class SoundRegistry {
  ...
  public static SoundType SCAFFOLD = new SoundType(1.0F, 1.0F, block_scaffolding_0, block_scaffolding_0, block_scaffolding_0, block_scaffolding_0, block_scaffolding_0);
