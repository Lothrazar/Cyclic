...
public class MaterialRegistry {
  ...
  public static class ArmorMats {
    public static final Holder<ArmorMaterial> EMERALD = ARMOR_MATERIALS.register("emerald", () -> new ArmorMaterial(
        ...
        3.0F, // toughness
        (net.minecraft.world.item.ArmorMaterials.DIAMOND.value().knockbackResistance() + net.minecraft.world.item.ArmorMaterials.NETHERITE.value().knockbackResistance()) / 2.0F
    ));
