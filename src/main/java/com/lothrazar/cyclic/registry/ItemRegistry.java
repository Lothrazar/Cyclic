...
public class ItemRegistry {
  ...
  public static final DeferredItem<Item> APPLE_PRISMARINE = ITEMS.register("apple_prismarine", () -> new FoodItemWithEffects(new Item.Properties().food(new FoodProperties.Builder().nutrition(APPLENUT).saturationModifier(APPLESATUR)
      ...
      .alwaysEdible()
      .build())));
  public static final DeferredItem<Item> APPLE_LAPIS = ITEMS.register("apple_lapis", () -> new FoodItemWithEffects(new Item.Properties().food(new FoodProperties.Builder().nutrition(APPLENUT).saturationModifier(APPLESATUR * 4)
      .effect(() -> FoodItemWithEffects.silent(MobEffects.NIGHT_VISION, LARGEPOTIONDUR, 0), 1)
      .effect(() -> FoodItemWithEffects.silent(MobEffects.WATER_BREATHING, LARGEPOTIONDUR, 0), 1)
  ...
  public static final DeferredItem<Item> CARROT_DIAMOND = ITEMS.register("carrot_diamond", () -> new ItemHorseHealthDiamondCarrot(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_REDSTONE = ITEMS.register("carrot_redstone", () -> new ItemHorseRedstoneSpeed(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_EMERALD = ITEMS.register("carrot_emerald", () -> new ItemHorseEmeraldJump(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_LAPIS = ITEMS.register("carrot_lapis", () -> new ItemHorseLapisVariant(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_TOXIC = ITEMS.register("carrot_toxic", () -> new ItemHorseToxic(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_QUARTZ = ITEMS.register("carrot_quartz", () -> new ItemHorseQuartzStep(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_COPPER = ITEMS.register("carrot_copper", () -> new ItemHorseCopperRadar(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_NETHERITE = ITEMS.register("carrot_netherite", () -> new ItemHorseNetheriteFire(new Item.Properties()));
  public static final DeferredItem<Item> CARROT_PRISMARINE = ITEMS.register("carrot_prismarine", () -> new ItemHorsePrismarineWater(new Item.Properties()));
  // ---- charms
  ...
  public static final DeferredItem<Item> CHARM_ANTIGRAVITY = ITEMS.register("charm_antigravity", () -> new AirAntiGravity(new Item.Properties().durability(1024 * 4)));
  ...
  public static final DeferredItem<Item> SCEPTER_MISSILE = ITEMS.register("scepter_missile", () -> new WandMissileItem(new Item.Properties()));
  public static final DeferredItem<Item> SCEPTER_BUILD = ITEMS.register("scepter_build", () -> new BuilderItem(new Item.Properties(), BuildStyle.NORMAL));
  public static final DeferredItem<Item> SCEPTER_REPLACE = ITEMS.register("scepter_replace", () -> new BuilderItem(new Item.Properties(), BuildStyle.REPLACE));
  public static final DeferredItem<Item> SCEPTER_OFFSET = ITEMS.register("scepter_offset", () -> new BuilderItem(new Item.Properties(), BuildStyle.OFFSET));
  public static final DeferredItem<Item> SCEPTER_RANDOMIZE = ITEMS.register("scepter_randomize", () -> new RandomizerItem(new Item.Properties()));
  public static final DeferredItem<Item> SCEPTER_SNOW = ITEMS.register("scepter_snow", () -> new SnowScepter(new Item.Properties().durability(256)));
  public static final DeferredItem<Item> SCEPTER_FIRE = ITEMS.register("scepter_fire", () -> new FireScepter(new Item.Properties().durability(256)));
  public static final DeferredItem<Item> SCEPTER_LIGHTNING = ITEMS.register("scepter_lightning", () -> new LightningScepter(new Item.Properties().durability(256)));
  public static final DeferredItem<Item> SCEPTER_WATER = ITEMS.register("scepter_water", () -> new WaterSpreaderItem(new Item.Properties().durability(256)));
  public static final DeferredItem<Item> SCEPTER_ICE = ITEMS.register("scepter_ice", () -> new IceWand(new Item.Properties().durability(256)));
  ...
  public static final DeferredItem<Item> SCEPTER_ELEVATION = ITEMS.register("scepter_elevation", () -> new ElevationWandItem(new Item.Properties().durability(256)));
  public static final DeferredItem<Item> SCEPTER_TELEPORT = ITEMS.register("scepter_teleport", () -> new TeleporterWandItem(new Item.Properties().durability(64)));
  public static final DeferredItem<Item> SCEPTER_ANTIMATTER = ITEMS.register("scepter_antimatter", () -> new AntimatterEvaporatorWandItem(new Item.Properties().durability(1024)));
  public static final DeferredItem<Item> SCEPTER_ROTATION = ITEMS.register("scepter_rotation", () -> new RotatorItem(new Item.Properties().durability(256)));
  ...
  // ---- equippable
  public static final DeferredItem<Item> GLOWING_HELMET = ITEMS.register("glowing_helmet", () -> new GlowingHelmetItem(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.GLOWING, ArmorType.HELMET)));
  public static final DeferredItem<Item> CRYSTAL_BOOTS = ITEMS.register("crystal_boots", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.GEMOBSIDIAN, ArmorType.BOOTS)));
  public static final DeferredItem<Item> CRYSTAL_HELMET = ITEMS.register("crystal_helmet", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.GEMOBSIDIAN, ArmorType.HELMET)));
  public static final DeferredItem<Item> CRYSTAL_CHESTPLATE = ITEMS.register("crystal_chestplate", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.GEMOBSIDIAN, ArmorType.CHESTPLATE)));
  public static final DeferredItem<Item> CRYSTAL_LEGGINGS = ITEMS.register("crystal_leggings", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.GEMOBSIDIAN, ArmorType.LEGGINGS)));
  public static final DeferredItem<Item> COPPER_BOOTS = ITEMS.register("copper_boots", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.COPPER, ArmorType.BOOTS)));
  public static final DeferredItem<Item> COPPER_HELMET = ITEMS.register("copper_helmet", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.COPPER, ArmorType.HELMET)));
  public static final DeferredItem<Item> COPPER_CHESTPLATE = ITEMS.register("copper_chestplate", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.COPPER, ArmorType.CHESTPLATE)));
  public static final DeferredItem<Item> COPPER_LEGGINGS = ITEMS.register("copper_leggings", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.COPPER, ArmorType.LEGGINGS)));
  public static final DeferredItem<Item> EMERALD_BOOTS = ITEMS.register("emerald_boots", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.EMERALD, ArmorType.BOOTS)));
  public static final DeferredItem<Item> EMERALD_HELMET = ITEMS.register("emerald_helmet", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.EMERALD, ArmorType.HELMET)));
  public static final DeferredItem<Item> EMERALD_CHESTPLATE = ITEMS.register("emerald_chestplate", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.EMERALD, ArmorType.CHESTPLATE)));
  public static final DeferredItem<Item> EMERALD_LEGGINGS = ITEMS.register("emerald_leggings", () -> new Item(new Item.Properties().stacksTo(1).humanoidArmor(MaterialRegistry.ArmorMats.EMERALD, ArmorType.LEGGINGS)));
  public static final DeferredItem<Item> AMETHYST_PICKAXE = ITEMS.register("amethyst_pickaxe", () -> new AmethystPickaxeItem(MaterialRegistry.ToolMats.AMETHYST, 1F, -2.8F, new Item.Properties()));
  public static final DeferredItem<Item> COPPER_PICKAXE = ITEMS.register("copper_pickaxe", () -> new Item(new Item.Properties().pickaxe(MaterialRegistry.ToolMats.COPPER, 1F, -2.8F)));
  public static final DeferredItem<Item> EMERALD_PICKAXE = ITEMS.register("emerald_pickaxe", () -> new Item(new Item.Properties().pickaxe(MaterialRegistry.ToolMats.EMERALD, 1F, -2.8F)));
  public static final DeferredItem<Item> CRYSTAL_PICKAXE = ITEMS.register("crystal_pickaxe", () -> new Item(new Item.Properties().pickaxe(MaterialRegistry.ToolMats.GEMOBSIDIAN, 1F, -2.8F)));
  public static final DeferredItem<Item> SANDSTONE_PICKAXE = ITEMS.register("sandstone_pickaxe", () -> new Item(new Item.Properties().pickaxe(MaterialRegistry.ToolMats.SANDSTONE, 1F, -2.8F)));
  public static final DeferredItem<Item> NETHERBRICK_PICKAXE = ITEMS.register("netherbrick_pickaxe", () -> new Item(new Item.Properties().pickaxe(MaterialRegistry.ToolMats.NETHERBRICK, 1F, -2.8F)));
  ...
  public static final DeferredItem<Item> COPPER_AXE = ITEMS.register("copper_axe", () -> new AxeItem(MaterialRegistry.ToolMats.COPPER, 6.0F, -3.1F, new Item.Properties()));
  public static final DeferredItem<Item> EMERALD_AXE = ITEMS.register("emerald_axe", () -> new AxeItem(MaterialRegistry.ToolMats.EMERALD, 6.0F, -3.1F, new Item.Properties()));
  public static final DeferredItem<Item> CRYSTAL_AXE = ITEMS.register("crystal_axe", () -> new AxeItem(MaterialRegistry.ToolMats.GEMOBSIDIAN, 6.0F, -3.1F, new Item.Properties()));
  public static final DeferredItem<Item> SANDSTONE_AXE = ITEMS.register("sandstone_axe", () -> new AxeItem(MaterialRegistry.ToolMats.SANDSTONE, 6.0F, -3.1F, new Item.Properties()));
  public static final DeferredItem<Item> NETHERBRICK_AXE = ITEMS.register("netherbrick_axe", () -> new AxeItem(MaterialRegistry.ToolMats.NETHERBRICK, 6.0F, -3.1F, new Item.Properties()));
  public static final DeferredItem<Item> AMETHYST_HOE = ITEMS.register("amethyst_hoe", () -> new AmethystHoeItem(ToolMats.AMETHYST, -4F, 0F, new Item.Properties()));
  public static final DeferredItem<Item> COPPER_HOE = ITEMS.register("copper_hoe", () -> new HoeItem(ToolMats.COPPER, -4F, 0F, new Item.Properties()));
  public static final DeferredItem<Item> EMERALD_HOE = ITEMS.register("emerald_hoe", () -> new HoeItem(ToolMats.EMERALD, -4F, 0F, new Item.Properties()));
  public static final DeferredItem<Item> CRYSTAL_HOE = ITEMS.register("crystal_hoe", () -> new HoeItem(ToolMats.GEMOBSIDIAN, -4F, 0F, new Item.Properties()));
  public static final DeferredItem<Item> SANDSTONE_HOE = ITEMS.register("sandstone_hoe", () -> new HoeItem(ToolMats.SANDSTONE, -4F, 0F, new Item.Properties()));
  public static final DeferredItem<Item> NETHERBRICK_HOE = ITEMS.register("netherbrick_hoe", () -> new HoeItem(ToolMats.NETHERBRICK, -4F, 0F, new Item.Properties()));
  ...
  public static final DeferredItem<Item> COPPER_SHOVEL = ITEMS.register("copper_shovel", () -> new ShovelItem(MaterialRegistry.ToolMats.COPPER, 1.5F, -3.0F, new Item.Properties()));
  public static final DeferredItem<Item> EMERALD_SHOVEL = ITEMS.register("emerald_shovel", () -> new ShovelItem(MaterialRegistry.ToolMats.EMERALD, 1.5F, -3.0F, new Item.Properties()));
  public static final DeferredItem<Item> CRYSTAL_SHOVEL = ITEMS.register("crystal_shovel", () -> new ShovelItem(MaterialRegistry.ToolMats.GEMOBSIDIAN, 1.5F, -3.0F, new Item.Properties()));
  public static final DeferredItem<Item> SANDSTONE_SHOVEL = ITEMS.register("sandstone_shovel", () -> new ShovelItem(MaterialRegistry.ToolMats.SANDSTONE, 1.5F, -3.0F, new Item.Properties()));
  public static final DeferredItem<Item> NETHERBRICK_SHOVEL = ITEMS.register("netherbrick_shovel", () -> new ShovelItem(MaterialRegistry.ToolMats.NETHERBRICK, 1.5F, -3.0F, new Item.Properties()));
  public static final DeferredItem<Item> AMETHYST_SWORD = ITEMS.register("amethyst_sword", () -> new Item(new Item.Properties().sword(MaterialRegistry.ToolMats.AMETHYST, 3F, -2.4F)));
  public static final DeferredItem<Item> COPPER_SWORD = ITEMS.register("copper_sword", () -> new Item(new Item.Properties().sword(MaterialRegistry.ToolMats.COPPER, 3F, -2.4F)));
  public static final DeferredItem<Item> EMERALD_SWORD = ITEMS.register("emerald_sword", () -> new Item(new Item.Properties().sword(MaterialRegistry.ToolMats.EMERALD, 3F, -2.4F)));
  public static final DeferredItem<Item> CRYSTAL_SWORD = ITEMS.register("crystal_sword", () -> new Item(new Item.Properties().sword(MaterialRegistry.ToolMats.GEMOBSIDIAN, 3F, -2.4F)));
  public static final DeferredItem<Item> SANDSTONE_SWORD = ITEMS.register("sandstone_sword", () -> new Item(new Item.Properties().sword(MaterialRegistry.ToolMats.SANDSTONE, 3F, -2.4F)));
  public static final DeferredItem<Item> NETHERBRICK_SWORD = ITEMS.register("netherbrick_sword", () -> new Item(new Item.Properties().sword(MaterialRegistry.ToolMats.NETHERBRICK, 3F, -2.4F)));
  ...
  public static final DeferredItem<Item> MATTOCK = ITEMS.register("mattock", () -> new MattockItem(ToolMaterial.DIAMOND, 9000, new Item.Properties(), 1));
  public static final DeferredItem<Item> MATTOCK_NETHER = ITEMS.register("mattock_nether", () -> new MattockItem(ToolMaterial.NETHERITE, 9001, new Item.Properties(), 2));
  public static final DeferredItem<Item> MATTOCK_STONE = ITEMS.register("mattock_stone", () -> new MattockItem(ToolMaterial.STONE, 1024, new Item.Properties(), 1));
...
public static final DeferredItem<Item> SHEARING = ITEMS.register("shearing", () -> new BlockItem(BlockRegistry.SHEARING.get(), new Item.Properties()));
 ...
 // ---- energy machine blocks
  ...
  // more blocks
  public static final DeferredItem<Item> SHELF = ITEMS.register("shelf", () -> new BlockItem(BlockRegistry.SHELF.get(), new Item.Properties()));
  ...
  // altars and beacons
  public static final DeferredItem<Item> CANDLE_WATER = ITEMS.register("candle_water", () -> new BlockItem(BlockRegistry.CANDLE_WATER.get(), new Item.Properties()));
  public static final DeferredItem<Item> CANDLE_PEACE = ITEMS.register("candle_peace", () -> new BlockItem(BlockRegistry.CANDLE_PEACE.get(), new Item.Properties()));
  ...
  public static final DeferredItem<Item> ALTAR_SOLICITING = ITEMS.register("altar_soliciting", () -> new BlockItem(BlockRegistry.ALTAR_SOLICITING.get(), new Item.Properties()));
  ...
  public static final DeferredItem<Item> BEACON_SPONGE = ITEMS.register("beacon_sponge", () -> new BlockItem(BlockRegistry.BEACON_SPONGE.get(), new Item.Properties()));
  ...
  public static final DeferredItem<Item> GLASS_DARK = ITEMS.register("glass_dark", () -> new BlockItem(BlockRegistry.GLASS_DARK.get(), new Item.Properties()));
  public static final DeferredItem<Item> GLASS_DARK_CONNECTED = ITEMS.register("glass_dark_connected", () -> new BlockItem(BlockRegistry.GLASS_DARK_CONNECTED.get(), new Item.Properties()));
  public static final DeferredItem<Item> GLASS_TERRA = ITEMS.register("glass_terra", () -> new BlockItem(BlockRegistry.GLASS_TERRA.get(), new Item.Properties()));
