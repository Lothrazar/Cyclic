...
import com.lothrazar.cyclic.item.ShieldCyclicItem.ShieldType;
...
public class ItemRegistry {
  ...
  public static final RegistryObject<Item> FIREBALL = ITEMS.register("fireball", () -> new FireballItem(new Item.Properties().tab(MaterialRegistry.ITEM_GROUP)));
