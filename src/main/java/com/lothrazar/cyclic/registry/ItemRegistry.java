...
public class ItemRegistry {
  ...
  public static void onItemsRegistry(RegistryEvent.Register<Item> event) {
    ...
    r.register(new HoeItem(Tiers.NETHERITE, -4, 0F, new Item.Properties().tab(MaterialRegistry.ITEM_GROUP)).setRegistryName("crystal_hoe"));
    ...
    r.register(new HoeItem(Tiers.NETHERITE, -4, 0F, new Item.Properties().tab(MaterialRegistry.ITEM_GROUP)).setRegistryName("emerald_hoe"));
    ...
    r.register(new HoeItem(Tiers.NETHERITE, -4, 0F, new Item.Properties().tab(MaterialRegistry.ITEM_GROUP)).setRegistryName("sandstone_hoe"));
    ...
    r.register(new HoeItem(Tiers.NETHERITE, -4, 0F, new Item.Properties().tab(MaterialRegistry.ITEM_GROUP)).setRegistryName("netherbrick_hoe"));
