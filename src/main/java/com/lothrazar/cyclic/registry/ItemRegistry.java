...
public class ItemRegistry {
  ...
  public static void onItemsRegistry(RegistryEvent.Register<Item> event) {
    ...
    r.register(new BlockItem(BlockRegistry.APPLE_SPROUT.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("apple_sprout"));
    r.register(new BlockItem(BlockRegistry.APPLE_SPROUT_DIAMOND.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("apple_sprout_diamond"));
    r.register(new BlockItem(BlockRegistry.APPLE_SPROUT_EMERALD.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("apple_sprout_emerald"));
    r.register(new BlockItem(BlockRegistry.COMPUTER_SHAPE.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("computer_shape"));
    r.register(new BlockItem(BlockRegistry.EYE_REDSTONE.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("eye_redstone"));
    r.register(new BlockItem(BlockRegistry.EYE_TELEPORT.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("eye_teleport"));
    r.register(new ItemBlockBattery(BlockRegistry.BATTERY.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("battery"));
    r.register(new BlockItem(BlockRegistry.PEAT_UNBAKED.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("peat_unbaked"));
    r.register(new BlockItem(BlockRegistry.PEAT_BAKED.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("peat_baked"));
    r.register(new BlockItem(BlockRegistry.SOLIDIFIER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("solidifier"));
    r.register(new BlockItem(BlockRegistry.PEAT_FARM.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("peat_farm"));
    r.register(new BlockItem(BlockRegistry.MELTER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("melter"));
    r.register(new BlockItem(BlockRegistry.PLACER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("placer"));
    r.register(new BlockItem(BlockRegistry.BREAKER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("breaker"));
    r.register(new BlockItem(BlockRegistry.USER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("user"));
    r.register(new BlockItem(BlockRegistry.DROPPER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("dropper"));
    r.register(new BlockItem(BlockRegistry.FORESTER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("forester"));
    r.register(new BlockItem(BlockRegistry.MINER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("miner"));
    r.register(new BlockItem(BlockRegistry.STRUCTURE.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("structure"));
    r.register(new BlockItem(BlockRegistry.HARVESTER.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("harvester"));
    r.register(new BlockItem(BlockRegistry.COLLECTOR.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("collector"));
    r.register(new BlockItem(BlockRegistry.COLLECTOR_FLUID.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("collector_fluid"));
    r.register(new BlockItem(BlockRegistry.PLACER_FLUID.get(), new Item.Properties().tab(MaterialRegistry.BLOCK_GROUP)).setRegistryName("placer_fluid"));
    //redstone
